---
name: ccgs-estimate
description: "[CCGS converted] Estimates task effort by analyzing complexity, dependencies, historical velocity, and risk factors. Produces a structured estimate with confidence levels."
---

> Converted from Claude Code Game Studios slash command `/estimate` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

...
description: "[CCGS converted] Audit GDD-specified content counts against implemented content. Identifies what's planned vs built."
---

> Converted from Claude Code Game Studios slash command `/content-audit` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

---
name: ccgs-changelog
description: "[CCGS converted] Auto-generates a changelog from git commits, sprint data, and design documents. Produces both internal and player-facing versions."
---

> Converted from Claude Code Game Studios slash command `/changelog` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

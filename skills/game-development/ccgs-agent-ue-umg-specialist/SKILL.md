---
name: ccgs-agent-ue-umg-specialist
description: "[CCGS agent converted] The UMG/CommonUI specialist owns all Unreal UI implementation: widget hierarchy, data binding, CommonUI input routing, widget styling, and UI optimization. They ensure UI follows Unreal best practices and performs well."
---

# CCGS Agent: ue-umg-specialist

Converted from Claude Code Game Studios `.claude/agents/ue-umg-specialist.md` into a Codex skill. Use this when you want the Codex response to follow this specialist role. Claude-specific subagent routing, model selection, memory, and disallowedTools are advisory only in Codex.

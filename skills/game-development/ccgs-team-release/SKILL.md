...
description: "[CCGS converted] Orchestrate the release team: coordinates release-manager, qa-lead, devops-engineer, and producer to execute a release from candidate to deployment."
---

> Converted from Claude Code Game Studios slash command `/team-release` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

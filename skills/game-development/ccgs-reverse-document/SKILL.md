...
description: "[CCGS converted] Generate design or architecture documents from existing implementation. Works backwards from code/prototypes to create missing planning docs."
---

> Converted from Claude Code Game Studios slash command `/reverse-document` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

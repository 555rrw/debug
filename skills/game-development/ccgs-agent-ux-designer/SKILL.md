---
name: ccgs-agent-ux-designer
description: "[CCGS agent converted] The UX Designer owns user experience flows, interaction design, accessibility, information architecture, and input handling design. Use this agent for user flow mapping, interaction pattern design, accessibility audits, or onboarding flow design."
---

# CCGS Agent: ux-designer

Converted from Claude Code Game Studios `.claude/agents/ux-designer.md` into a Codex skill. Use this when you want the Codex response to follow this specialist role. Claude-specific subagent routing, model selection, memory, and disallowedTools are advisory only in Codex.

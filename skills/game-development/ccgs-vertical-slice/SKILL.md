...
> Converted from Claude Code Game Studios slash command `/vertical-slice` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

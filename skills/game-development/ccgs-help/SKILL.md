---
name: ccgs-help
description: "[CCGS converted] Analyzes what is done and the users query and offers advice on what to do next. Use if user says what should I do next or what do I do now or I'm stuck or I don't know what to do"
---

> Converted from Claude Code Game Studios slash command `/help` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

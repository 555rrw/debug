...
description: "[CCGS converted] Structured performance profiling workflow. Identifies bottlenecks, measures against budgets, and generates optimization recommendations with priority rankings."
---

> Converted from Claude Code Game Studios slash command `/perf-profile` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

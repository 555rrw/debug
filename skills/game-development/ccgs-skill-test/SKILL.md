...
description: "[CCGS converted] Validate skill files for structural compliance and behavioral correctness. Three modes: static (linter), spec (behavioral), audit (coverage report)."
---

> Converted from Claude Code Game Studios slash command `/skill-test` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

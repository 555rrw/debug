---
name: ccgs-onboard
description: "[CCGS converted] Generates a contextual onboarding document for a new contributor or agent joining the project. Summarizes project state, architecture, conventions, and current priorities relevant to the specified role or area."
---

> Converted from Claude Code Game Studios slash command `/onboard` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

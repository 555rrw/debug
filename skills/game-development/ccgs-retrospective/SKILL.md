...
description: "[CCGS converted] Generates a sprint or milestone retrospective by analyzing completed work, velocity, blockers, and patterns. Produces actionable insights for the next iteration."
---

> Converted from Claude Code Game Studios slash command `/retrospective` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

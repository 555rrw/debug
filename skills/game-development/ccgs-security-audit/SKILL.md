...
description: "[CCGS converted] Audit the game for security vulnerabilities: save tampering, cheat vectors, network exploits, data exposure, and input validation gaps. Produces a prioritised security report with remediation guidance. Run before any public release or multiplayer launch."
---

> Converted from Claude Code Game Studios slash command `/security-audit` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

---
name: ccgs-agent-analytics-engineer
description: "[CCGS agent converted] The Analytics Engineer designs telemetry systems, player behavior tracking, A/B test frameworks, and data analysis pipelines. Use this agent for event tracking design, dashboard specification, A/B test design, or player behavior analysis methodology."
---

# CCGS Agent: analytics-engineer

Converted from Claude Code Game Studios `.claude/agents/analytics-engineer.md` into a Codex skill. Use this when you want the Codex response to follow this specialist role. Claude-specific subagent routing, model selection, memory, and disallowedTools are advisory only in Codex.

---
name: ccgs-tech-debt
description: "[CCGS converted] Track, categorize, and prioritize technical debt across the codebase. Scans for debt indicators, maintains a debt register, and recommends repayment scheduling."
---

> Converted from Claude Code Game Studios slash command `/tech-debt` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

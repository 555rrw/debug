---
name: ccgs-art-bible
description: "[CCGS converted] Guided, section-by-section Art Bible authoring. Creates the visual identity specification that gates all asset production. Run after /brainstorm is approved and before /map-systems or any GDD authoring begins."
---

> Converted from Claude Code Game Studios slash command `/art-bible` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

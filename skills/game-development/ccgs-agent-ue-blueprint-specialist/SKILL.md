---
name: ccgs-agent-ue-blueprint-specialist
description: "[CCGS agent converted] The Blueprint specialist owns Blueprint architecture decisions, Blueprint/C++ boundary guidelines, Blueprint optimization, and ensures Blueprint graphs stay maintainable and performant. They prevent Blueprint spaghetti and enforce clean BP patterns."
---

# CCGS Agent: ue-blueprint-specialist

Converted from Claude Code Game Studios `.claude/agents/ue-blueprint-specialist.md` into a Codex skill. Use this when you want the Codex response to follow this specialist role. Claude-specific subagent routing, model selection, memory, and disallowedTools are advisory only in Codex.

...
description: "[CCGS converted] Guided, section-by-section GDD authoring for a single game system. Gathers context from existing docs, walks through each required section collaboratively, cross-references dependencies, and writes incrementally to file."
---

> Converted from Claude Code Game Studios slash command `/design-system` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

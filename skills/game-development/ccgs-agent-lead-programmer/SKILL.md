---
name: ccgs-agent-lead-programmer
description: "[CCGS agent converted] The Lead Programmer owns code-level architecture, coding standards, code review, and the assignment of programming work to specialist programmers. Use this agent for code reviews, API design, refactoring strategy, or when determining how a design should be translated into code structure."
---

# CCGS Agent: lead-programmer

Converted from Claude Code Game Studios `.claude/agents/lead-programmer.md` into a Codex skill. Use this when you want the Codex response to follow this specialist role. Claude-specific subagent routing, model selection, memory, and disallowedTools are advisory only in Codex.

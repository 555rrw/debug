...
description: "[CCGS converted] Orchestrate level design team: level-designer + narrative-director + world-builder + art-director + systems-designer + qa-tester for complete area/level creation."
---

> Converted from Claude Code Game Studios slash command `/team-level` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

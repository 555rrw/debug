...
description: "[CCGS converted] Orchestrate the combat team: coordinates game-designer, gameplay-programmer, ai-programmer, technical-artist, sound-designer, and qa-tester to design, implement, and validate a combat feature end-to-end."
---

> Converted from Claude Code Game Studios slash command `/team-combat` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

...
description: "[CCGS converted] Generates a structured playtest report template or analyzes existing playtest notes into a structured format. Use this to standardize playtest feedback collection and analysis."
---

> Converted from Claude Code Game Studios slash command `/playtest-report` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

...
> Converted from Claude Code Game Studios slash command `/review-all-gdds` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

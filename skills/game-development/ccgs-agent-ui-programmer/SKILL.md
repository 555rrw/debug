---
name: ccgs-agent-ui-programmer
description: "[CCGS agent converted] The UI Programmer implements user interface systems: menus, HUDs, inventory screens, dialogue boxes, and UI framework code. Use this agent for UI system implementation, widget development, data binding, or screen flow programming."
---

# CCGS Agent: ui-programmer

Converted from Claude Code Game Studios `.claude/agents/ui-programmer.md` into a Codex skill. Use this when you want the Codex response to follow this specialist role. Claude-specific subagent routing, model selection, memory, and disallowedTools are advisory only in Codex.

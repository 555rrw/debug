...
description: "[CCGS converted] Decompose a game concept into individual systems, map dependencies, prioritize design order, and create the systems index."
---

> Converted from Claude Code Game Studios slash command `/map-systems` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

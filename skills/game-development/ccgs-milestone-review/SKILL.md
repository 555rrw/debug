...
description: "[CCGS converted] Generates a comprehensive milestone progress review including feature completeness, quality metrics, risk assessment, and go/no-go recommendation. Use at milestone checkpoints or when evaluating readiness for a milestone deadline."
---

> Converted from Claude Code Game Studios slash command `/milestone-review` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

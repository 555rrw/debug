...
description: "[CCGS converted] Orchestrate audio team: audio-director + sound-designer + technical-artist + gameplay-programmer for full audio pipeline from direction to implementation."
---

> Converted from Claude Code Game Studios slash command `/team-audio` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

---
name: ccgs-agent-release-manager
description: "[CCGS agent converted] Owns the release pipeline: certification checklists, store submissions, platform requirements, version numbering, and release-day coordination. Use for release planning, platform certification, store page preparation, or version management."
---

# CCGS Agent: release-manager

Converted from Claude Code Game Studios `.claude/agents/release-manager.md` into a Codex skill. Use this when you want the Codex response to follow this specialist role. Claude-specific subagent routing, model selection, memory, and disallowedTools are advisory only in Codex.

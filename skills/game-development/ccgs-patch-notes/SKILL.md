...
description: "[CCGS converted] Generate player-facing patch notes from git history, sprint data, and internal changelogs. Translates developer language into clear, engaging player communication."
---

> Converted from Claude Code Game Studios slash command `/patch-notes` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

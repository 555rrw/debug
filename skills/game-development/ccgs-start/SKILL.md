---
name: ccgs-start
description: "[CCGS converted] First-time onboarding — asks where you are, then guides you to the right workflow. No assumptions."
---

> Converted from Claude Code Game Studios slash command `/start` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

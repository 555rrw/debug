...
> Converted from Claude Code Game Studios slash command `/story-readiness` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

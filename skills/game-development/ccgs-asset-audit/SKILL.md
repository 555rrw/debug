...
description: "[CCGS converted] Audits game assets for compliance with naming conventions, file size budgets, format standards, and pipeline requirements. Identifies orphaned assets, missing references, and standard violations."
---

> Converted from Claude Code Game Studios slash command `/asset-audit` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

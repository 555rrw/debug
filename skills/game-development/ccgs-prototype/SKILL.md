---
name: ccgs-prototype
description: "[CCGS converted] Concept prototype — validate the core idea is worth designing before writing GDDs. Run right after /brainstorm and /setup-engine. Routes to HTML, Engine, or Paper path based on game type. Produces a throwaway build and a PROCEED/PIVOT/KILL verdict."
---

> Converted from Claude Code Game Studios slash command `/prototype` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

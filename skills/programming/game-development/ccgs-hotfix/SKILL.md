---
name: ccgs-hotfix
description: "[CCGS converted] Emergency fix workflow that bypasses normal sprint processes with a full audit trail. Creates hotfix branch, tracks approvals, and ensures the fix is backported correctly."
---

> Converted from Claude Code Game Studios slash command `/hotfix` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

...
description: "[CCGS converted] Creates a structured bug report from a description, or analyzes code to identify potential bugs. Ensures every bug report has full reproduction steps, severity assessment, and context."
---

> Converted from Claude Code Game Studios slash command `/bug-report` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

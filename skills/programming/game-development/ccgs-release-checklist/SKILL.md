...
description: "[CCGS converted] Generates a comprehensive pre-release validation checklist covering build verification, certification requirements, store metadata, and launch readiness."
---

> Converted from Claude Code Game Studios slash command `/release-checklist` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

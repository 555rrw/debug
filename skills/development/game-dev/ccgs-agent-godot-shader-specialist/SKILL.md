---
name: ccgs-agent-godot-shader-specialist
description: "[CCGS agent converted] The Godot Shader specialist owns all Godot rendering customization: Godot shading language, visual shaders, material setup, particle shaders, post-processing, and rendering performance. They ensure visual quality within Godot's rendering pipeline."
---

# CCGS Agent: godot-shader-specialist

Converted from Claude Code Game Studios `.claude/agents/godot-shader-specialist.md` into a Codex skill. Use this when you want the Codex response to follow this specialist role. Claude-specific subagent routing, model selection, memory, and disallowedTools are advisory only in Codex.

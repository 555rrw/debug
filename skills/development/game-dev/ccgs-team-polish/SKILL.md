...
description: "[CCGS converted] Orchestrate the polish team: coordinates performance-analyst, technical-artist, sound-designer, and qa-tester to optimize, polish, and harden a feature or area for release quality."
---

> Converted from Claude Code Game Studios slash command `/team-polish` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

...
description: "[CCGS converted] Creates an Architecture Decision Record (ADR) documenting a significant technical decision, its context, alternatives considered, and consequences. Every major technical choice should have an ADR."
---

> Converted from Claude Code Game Studios slash command `/architecture-decision` for Codex use. Claude-specific tool/model/hook fields were omitted from frontmatter.

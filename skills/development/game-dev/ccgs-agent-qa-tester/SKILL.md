---
name: ccgs-agent-qa-tester
description: "[CCGS agent converted] The QA Tester writes detailed test cases, bug reports, and test checklists. Use this agent for test case generation, regression checklist creation, bug report writing, or test execution documentation."
---

# CCGS Agent: qa-tester

Converted from Claude Code Game Studios `.claude/agents/qa-tester.md` into a Codex skill. Use this when you want the Codex response to follow this specialist role. Claude-specific subagent routing, model selection, memory, and disallowedTools are advisory only in Codex.
